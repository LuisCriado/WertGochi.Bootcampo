...
function namePet(){
	...
	function showName($answer) {
		...
		if ($answerLength > 0) {
			...
			var message = "Felicitaciones por crear Tu Personahe : " + $answer.toUpperCase() + "Espero que le des una buena vida!\n Juega con los botones!"
...
function changeMood(situation){
	...
	function deathSetup(){
		...
		$porgImg.attr("src", "https://as01.epimg.net/epik/imagenes/2020/05/30/fotorrelato/1590839136_056021_1590839583_album_grande.jpg");
	...
	function birthSetup(){
		...
		$porgImg.attr("src", "https://as01.epimg.net/epik/imagenes/2020/05/30/fotorrelato/1590839136_056021_1590839580_album_grande.jpg");
		$porgImg.show();
	}
...
$quitConfirmButton.on('click', function(e){
	window.location = "https://as01.epimg.net/epik/imagenes/2020/05/30/fotorrelato/1590839136_056021_1590839581_album_grande.jpg";
})
